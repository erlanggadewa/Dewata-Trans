				...
				<div class="container g-3">
					<div class="row">
						...
						<div class="col-6 form-group">
							...
							<input required type="date" class="form-control" id="tanggal-sewa" name="tanggal_sewa">
						</div>
						<div class="col-6 form-group">
							<label for="tanggal-kembali">Tanggal Kembali</label>
							<input required type="date" class="form-control" id="tanggal-kembali" name="tanggal_kembali">
						</div>
						<div class="col-6 form-group">
