    ...
    <div class="wrapper-tambah g-0">
      ...
      <form action="" class="" method="post" id="form-data" enctype="multipart/form-data">
        <div class="container g-3">
          <div class="row">
            <input autocomplete="off" type="hidden" name="idTarget" value="<?= $data[0]['id_customer'] ?>">
            <div class="col-12 form-group">
              <label for="nama-penyewa">Nama Penyewa</label>
              <input autocomplete="off" required type="text" class="form-control" placeholder="Enter name" id="nama-penyewa" name="nama_penyewa" value="<?= $data[0]['nama_penyewa'] ?>">
            </div>
            ...
            <div class="col-6 form-group">
              ...
              <input autocomplete="off" required type="date" class="form-control" id="tanggal-sewa" name="tanggal_sewa" value="<?= $data[0]['tanggal_sewa'] ?>">
            </div>
            <div class="col-6 form-group">
              <label for="tanggal-kembali">Tanggal Kembali</label>
              <input autocomplete="off" required type="date" class="form-control" id="tanggal-kembali" name="tanggal_kembali" value="<?= $data[0]['tanggal_kembali'] ?>">
            </div>
            <div class="col-6 form-group">
              <label for="kota-asal">Kota Asal</label>
              <input autocomplete="off" required type="text" class="form-control" placeholder="Enter origin" id="kota-asal" name="kota_asal" value="<?= $data[0]['kota_asal'] ?>">
            </div>
            <div class="col-6 form-group">
            ...
            <div class="col-6 form-group">
              ...
              <input autocomplete="off" required type="number" class="form-control" placeholder="Enter price" id="total-harga" name="total_harga" value="<?= $data[0]['total_harga_rental'] ?>">
            </div>
            <div class="form-group">
              <label for="gambar-mobil">Gambar Penyewa</label>
              <br>
              <input autocomplete="off" type="file" accept="image/*" class="form-control-file" id="gambar-penyewa" name="gambar" value="<?= $data[0]['gambar_customer'] ?>">
            </div>
