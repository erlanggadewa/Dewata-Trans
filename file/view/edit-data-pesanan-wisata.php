				...
				<div class="container g-3">
					<div class="row">
						<div class="col-12 form-group">
							...
							<input type="text" class="form-control" placeholder="Enter name" id="nama-penyewa" name="nama_penyewa" required value="<?= $data[0]['nama_penyewa'] ?>">
						</div>
						<div class="col-6 form-group">
							<label for="no-hp">No. HP</label>
							<input type="text" class="form-control" placeholder="Enter phone number" id="no-hp" name="no_hp" required value="<?= $data[0]['no_hp'] ?>">
						</div>
						<div class="col-6 form-group">
						...
						<div class="col-6 form-group">
							...
							<input type="date" class="form-control" id="tanggal-sewa" name="tanggal_sewa" required value="<?= $data[0]['tanggal_sewa'] ?>">
						</div>
						<div class="col-6 form-group">
							<label for="tanggal-kembali">Tanggal Kembali</label>
							<input type="date" class="form-control" id="tanggal-kembali" name="tanggal_kembali" required value="<?= $data[0]['tanggal_kembali'] ?>">
						</div>
						<div class="col-6 form-group">
							<label for="kota-asal">Kota Asal</label>
							<input type="text" class="form-control" placeholder="Enter origin" id="kota-asal" name="kota_asal" required value="<?= $data[0]['kota_asal'] ?>">
						</div>
						<div class="col-6 form-group">
						...
						<div class="col-6 form-group group-supir">
							...
							<input type="number" class="form-control" placeholder="Ketik ..." id="no-hp-supir" name="no_hp_supir" value="<?= $data[0]['no_hp_supir'] ?>">
						</div>
						<div class="col-6 form-group">
						...
						<div class="col-6 form-group">
							...
							<input type="number" class="form-control" placeholder="Enter price" id="total-harga" name="total_harga" value="<?= $data[0]['total_harga_wisata'] ?>">
						</div>
						...
						<div class="container wrapper-button">
							<input type="hidden" value="<?= $_POST['idTarget'] ?>" name="idTarget">
