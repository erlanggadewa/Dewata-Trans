          ...
          <div class="container g-3">
            <div class="row">
              ...
              <div class="col-12 form-group">
                ...
                <textarea type="text" class="form-control" placeholder="Masukan fasilitas paket" id="fasilitas" name="fasilitas" required rows="10" value=""><?= $data[0]['fasilitas'] ?></textarea>
              </div>
